...
#define DC_REPLY_SDP_GENERIC_EXCEPTION	150
#define DC_REPLY_SDP_PARSING_FAILED		151
#define DC_REPLY_SDP_EMPTY_ANSWER		152
#define DC_REPLY_SDP_STREAMS_COUNT		153
#define DC_REPLY_SDP_STREAMS_TYPES		154
